...
<!--<script type="text/javascript">function add_chatwidget(){var hccid=77091202;var nt=document.createElement("script");nt.async=true;nt.src="https://www.mylivechat.com/chatwidget.aspx?hccid="+hccid;var ct=document.getElementsByTagName("script")[0];ct.parentNode.insertBefore(nt,ct);}
				...
				<?php
					if( have_rows('columns') ):
						while ( have_rows('columns') ) : the_row();
						   	$link = get_sub_field('link'); ?>
							<?php if ($link && $link['url'] != "" && $link['title'] != ""): ?>
...
<!--middle left script-->
<!--<script type="text/javascript" async="async" defer="defer" data-cfasync="false" src="http://mylivechat.com/chatwidget.aspx?hccid=77091202"></script>-->
...
add_chatwidget();</script>-->
<!--Add the following script at the bottom of the web page (before </body></html>)
<script type="text/javascript">function add_chatwidget(){var hccid=77091202&WidgetStartPos=topleft&WidgetPosition=topleft;var nt=document.createElement("script");nt.async=true;nt.src="https://www.mylivechat.com/chatwidget.aspx?hccid="+hccid;var ct=document.getElementsByTagName("script")[0];ct.parentNode.insertBefore(nt,ct);}
add_chatwidget();</script>-->
<!--Add the following script at the bottom of the web page (before </body></html>)
<script type="text/javascript">function add_chatwidget(){var hccid=77091202&WidgetOffsetY=250;var nt=document.createElement("script");nt.async=true;nt.src="https://www.mylivechat.com/chatwidget.aspx?hccid="+hccid;var ct=document.getElementsByTagName("script")[0];ct.parentNode.insertBefore(nt,ct);}
add_chatwidget();</script>-->
